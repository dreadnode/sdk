...
# Assuming the new Toolset definition is in a module like 'dreadnode.toolset'
# This import will bring in the base class and the new decorator.

load("coreclr")

import clr  # type: ignore [import-untyped] # noqa: E402

lib_dir = Path(__file__).parent / "ilspy"
...
@tool(name="Download NuGet package")
...
class DotnetReversing(Toolset):
    ...
    @tool_method(
        name="decompile_module",
        description="Decompile the entire module and return the decompiled code as a string.",
    )
    ...
    @tool_method(
        name="decompile_type",
        description="Decompile a specific type and return the decompiled code as a string.",
    )
    def decompile_type(
        self,
    ...
    @tool_method(
        name="decompile_methods",
        description="Decompile specific methods and return a dictionary with method names as keys and decompiled code as values.",
    )
    ...
    @tool_method(name="list_namespaces", description="List all namespaces in the assembly.")
    ...
    @tool_method(
        name="list_types_in_namespace",
        description="List all types in the specified namespace.",
    )
    ...
    @tool_method(
        ...
        description="List all methods in the specified type.",
    )
    ...
    @tool_method(name="list_types", description="List all types in the assembly.")
    ...
    @tool_method(
        name="list_methods",
        description="List all methods in the assembly and return their full names.",
    )
    ...
    @tool_method(
        name="search_for_references",
        description="Locate all methods inside the assembly that reference the search string.",
    )
    ...
    @tool_method(
        name="search_by_name",
        description="Search for types and methods in the assembly that match the search string.",
    )
    def search_by_name(
        self,
        path: t.Annotated[str, "The binary file path"],
    ...
    @tool_method(
        name="get_call_flows_to_method",
        description="Find all unique call flows to the target method inside provided assemblies.",
    )
