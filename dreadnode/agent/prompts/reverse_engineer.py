...
from dreadnode.agent.types import prompt


@dataclass
class Findings:
    """
    Represents the findings from the reverse engineering process.
    """
...
@prompt
async def verify_findings(findings: Findings) -> str:
    """
