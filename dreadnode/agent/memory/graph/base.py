...
Label = str
EdgeType = str
TripletKey = tuple[Label, Label]  # (src_label, dst_label)


@dataclass(frozen=True)
class Universe:
    labels: set[Label]
    allowed: dict[TripletKey, set[EdgeType]]  # (src_label, dst_label) -> {"Has","LedTo",...}
...
NODES_PD_DTYPES = {
    ...
    "attributes": "string[pyarrow]",  # JSON
}
...
EDGE_EVENTS_PD_DTYPES = {
    ...
    "event_kind": "string[pyarrow]",  # "open" | "close"
