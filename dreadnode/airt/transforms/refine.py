...
from dreadnode.core.generators.models import XMLModel, element
...
class Input(XMLModel):
    guidance: str = element()
    context: str = element()


class Refinement(XMLModel):
...
def llm_refine(
    ...
    *,
    ...
    async def transform(
        object: t.Any,
        *,
        model: str | Generator = Config(model, help="The model to use", expose_as=str),  # noqa: B008
