...
from dreadnode.airt.attack.generative import GenerativeAttack
from dreadnode.scorers import llm_judge
from dreadnode.scorers.base import Scorer, ScorerLike  # noqa: F401
from dreadnode.transforms import llm_refine


class TAPAttack(GenerativeAttack[str]):
    """
    ...
    # Override defaults to be TAP-specific
    beam_width: int = 10
