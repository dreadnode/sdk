...
from dreadnode.agent.tools.format import format_tool, format_tools_table
from dreadnode.discovery import DEFAULT_SEARCH_PATHS, DEFAULT_TOOL_SEARCH_PATH, discover
...
def show(
    file: Path | None = DEFAULT_TOOL_SEARCH_PATH,
    *,
    verbose: t.Annotated[
        bool,
