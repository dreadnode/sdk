...
from dreadnode.core.generators.exceptions import MissingModelError
from dreadnode.core.generators.utils import (
    escape_xml,
    to_xml_tag,
    unescape_cdata_tags,
    unescape_xml,
...
def make_from_schema(
    ...
    *,
    ...
    return create_pydantic_xml_model(name, __base__=XMLModel, **fields)  # type: ignore [arg-type]
