...
class StudyResult(t.Generic[CandidateT]):
    ...
    Attributes:
        ...
        probes: A complete list of all probing trials generated during the study.
        stop_reason: The reason the study concluded.
        stop_explanation: A human-readable explanation for why the study stopped (often from stop conditions
    """
