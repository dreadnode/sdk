...
from dreadnode.core.tracing.span import RunSpan, current_run_span, current_task_span
...
class DatasetField(Context):
    ...
    def _resolve(self) -> t.Any:
        from dreadnode.core.evaluations.evaluation import current_dataset_row
...
class CurrentTrial(Context):
    ...
    def _resolve(self) -> t.Any:
        from dreadnode.core.optimization.study import current_trial
