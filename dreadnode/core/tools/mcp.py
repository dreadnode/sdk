...
from dreadnode.core.generators.exceptions import Stop
from dreadnode.core.generators.utils import flatten_list
from dreadnode.core.tools.tools import Tool
...
if t.TYPE_CHECKING:
    ...
    from dreadnode.core.generators.message import Content
...
def as_mcp(
    *tools: t.Any,
    ...
    Example:
        ...
        import asyncio
        from dreadnode.tools import tool, Tool
