...
from dreadnode.core.generators.message import ContentImageUrl
        ...
        *,
        ...
        async def search_file(file_path: UPath) -> list[GrepMatch | str]:
            ...
            try:
                ...
                elif isinstance(content, ContentImageUrl):
                    # Can't grep images
                    return []
...
class LocalFilesystem(FilesystemBase):
    ...
    async def read_file(
        ...
        Returns:
            ...
            - ContentImageUrl: If the file is non-text and multi_modal is True.
        ...
        try:
            ...
            if self.multi_modal:
                return ContentImageUrl.from_file(path)
...
class S3Filesystem(FilesystemBase):
    ...
    async def write_lines(
        ...
        try:
            ...
            elif isinstance(existing_content, ContentImageUrl):
