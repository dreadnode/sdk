...
<Note>
**Self-Hosted Users**: When creating projects manually, use your self-hosted platform's UI rather than the hosted platform. The project creation functionality works the same way on both platforms.
</Note>
