...
<Tip>
Our agent use [Rigging](https://github.com/dreadnode/rigging) to interact with the LLMs, provide tools, and track inference data. If you aren't already familiar, we recommend checking out the following resources:

- [Introduction](/open-source/rigging/intro)
- [Generators](/open-source/rigging/topics/generators)
- [Tools](/open-source/rigging/topics/tools)
