...
```python
ascii_art(font: str = 'rand', *, name: str = 'ascii_art') -> Transform[str, str]
```
...
```python
TransformCallable = Callable[[In], Awaitable[Out] | Out] | Callable[Concatenate[In, ...], Awaitable[Out] | Out]
```
...
```python
Transform(func: TransformCallable[In, Out], *, name: str | None = None, catch: bool = False, config: dict[str, ConfigInfo] | None = None, context: dict[str, Context] | None = None)
```
...
```python
adapt(adapt_in: Callable[[OuterIn], In], adapt_out: Callable[[Out], OuterOut], name: str | None = None) -> Transform[OuterIn, OuterOut]
```
...
```python
fit(transform: TransformLike[In, Out]) -> Transform[In, Out]
```
...
```python
with_(*, name: str | None = None, catch: bool | None = None) -> Transform[In, Out]
```
...
```python
atbash_cipher(*, name: str = 'atbash') -> Transform[str, str]
```
...
```python
caesar_cipher(offset: int, *, name: str = 'caesar') -> Transform[str, str]
```
...
```python
ascii85_encode(*, name: str = 'ascii85') -> Transform[str, str]
```
...
```python
base32_encode(*, name: str = 'base32') -> Transform[str, str]
```
...
```python
base64_encode(*, name: str = 'base64') -> Transform[str, str]
```
...
```python
binary_encode(bits_per_char: int = 16, *, name: str = 'binary') -> Transform[str, str]
```
...
```python
html_escape(*, name: str = 'html_escape') -> Transform[str, str]
```
...
```python
url_encode(*, name: str = 'url_encode') -> Transform[str, str]
```
...
```python
llm_refine(model: str | Generator, guidance: str, *, model_params: AnyDict | None = None, name: str = 'llm_refine') -> Transform[t.Any, str]
```
...
prompt\_trials\_adapter
-----------------------

```python
prompt_trials_adapter(trials: Trials[str]) -> str
```
...
```python
character_space(*, name: str = 'character_space') -> Transform[str, str]
```
...
```python
diacritic(target_chars: str = 'aeiou', accent: Literal['acute', 'grave', 'tilde', 'umlaut'] = 'acute', *, name: str = 'diacritic') -> Transform[str, str]
```
...
```python
insert_punctuation(*, ratio: float = 0.2, punctuations: list[str] | None = None, seed: int | None = None, name: str = 'insert_punctuation') -> Transform[str, str]
```
...
```python
random_capitalization(*, ratio: float = 0.2, seed: int | None = None, name: str = 'random_capitalization') -> Transform[str, str]
```
...
```python
underline(*, name: str = 'underline') -> Transform[str, str]
```
...
```python
unicode_confusable(*, ratio: float = 1.0, deterministic: bool = False, seed: int | None = None, name: str = 'unicode_confusable') -> Transform[str, str]
```
...
```python
unicode_replacement(*, encode_spaces: bool = False, name: str = 'unicode_replacement') -> Transform[str, str]
```
...
```python
unicode_substitution(*, start_value: int = 917504, name: str = 'unicode_substitution') -> Transform[str, str]
```
...
```python
zalgo(intensity: int = 10, *, ratio: float = 1.0, seed: int | None = None, name: str | None = None) -> Transform[str, str]
```
...
```python
zero_width(*, name: str = 'zero_width') -> Transform[str, str]
```
...
```python
affix(text_to_add: str, *, position: Literal['prefix', 'suffix'] = 'prefix', delimiter: str = ' ', name: str = 'affix') -> Transform[str, str]
```
...
```python
char_join(delimiter: str = '-', *, name: str = 'char_join') -> Transform[str, str]
```
...
```python
join(delimiter: str, *, unit: Literal['char', 'word'] = 'char', name: str = 'join') -> Transform[str, str]
```
...
```python
prefix(text: str, *, name: str = 'prefix') -> Transform[str, str]
```
...
```python
search_replace(pattern: str | Pattern[str], replacement: str | list[str], *, regex: bool = False, case_sensitive: bool = False, seed: int | None = None, deterministic: bool = False, name: str = 'search_replace') -> Transform[str, str]
```
...
```python
suffix(text: str, *, name: str = 'suffix') -> Transform[str, str]
```
...
```python
word_join(delimiter: str = '-', *, name: str = 'word_join') -> Transform[str, str]
```
...
```python
bubble_text(*, name: str = 'bubble_text') -> Transform[str, str]
```
...
```python
double_struck(*, name: str = 'double_struck') -> Transform[str, str]
```
...
```python
elder_futhark(*, name: str = 'elder_futhark') -> Transform[str, str]
```
...
```python
greek_letters(*, name: str = 'greek_letters') -> Transform[str, str]
```
...
```python
leet_speak(*, deterministic: bool = False, seed: int | None = None, name: str = 'leet_speak') -> Transform[str, str]
```
...
```python
monospace(*, name: str = 'monospace') -> Transform[str, str]
```
...
```python
morse_code(*, name: str = 'morse_code') -> Transform[str, str]
```
...
```python
nato_phonetic(*, name: str = 'nato_phonetic') -> Transform[str, str]
```
...
```python
pig_latin(*, name: str = 'pig_latin') -> Transform[str, str]
```
...
```python
small_caps(*, name: str = 'small_caps') -> Transform[str, str]
```
...
```python
substitute(mapping: Mapping[str, str | list[str]], *, unit: Literal['char', 'word'] = 'word', case_sensitive: bool = False, deterministic: bool = False, seed: int | None = None, name: str = 'substitute') -> Transform[str, str]
```
...
```python
wingdings(*, name: str = 'wingdings') -> Transform[str, str]
```
...
```python
adjacent_char_swap(*, ratio: float = 0.1, seed: int | None = None, name: str = 'adjacent_char_swap') -> Transform[str, str]
```
...
```python
random_word_reorder(*, ratio: float = 0.1, seed: int | None = None, name: str = 'random_word_reorder') -> Transform[str, str]
```
...
```python
swap(*, unit: Literal['char', 'word'] = 'char', mode: Literal['adjacent', 'random'] = 'adjacent', ratio: float = 0.1, seed: int | None = None, name: str = 'general_swap') -> Transform[str, str]
```
