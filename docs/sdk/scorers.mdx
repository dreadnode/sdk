...
```python
ScorerCallable = Callable[[T], Awaitable[ScorerResult] | ScorerResult] | Callable[[T], Awaitable[Sequence[ScorerResult]] | Sequence[ScorerResult]] | Callable[Concatenate[T, ...], Awaitable[ScorerResult] | ScorerResult] | Callable[Concatenate[T, ...], Awaitable[Sequence[ScorerResult]] | Sequence[ScorerResult]]
```
...
```python
Scorer(func: ScorerCallable[T], *, name: str | None = None, attributes: JsonDict | None = None, catch: bool = False, step: int = 0, auto_increment_step: bool = False, log_all: bool = False, config: dict[str, ConfigInfo] | None = None, context: dict[str, Context] | None = None, wraps: Callable[..., Any] | None = None)
```
...
```python
adapt(type: type[OuterT], adapt: Callable[[OuterT], T], name: str | None = None) -> Scorer[OuterT]
```
...
```python
fit_like(scorers: ScorersLike[T] | None, *, attributes: JsonDict | None = None) -> list[Scorer[T]]
```
...
```python
with_(name: str | None = None, attributes: JsonDict | None = None, step: int | None = None, auto_increment_step: bool | None = None, catch: bool | None = None, log_all: bool | None = None) -> Scorer[T]
```
...
```python
add(scorer: Scorer[T], other: Scorer[T], *, average: bool = False, name: str | None = None) -> Scorer[T]
```
...
```python
and_(scorer: Scorer[T], other: Scorer[T], *, name: str | None = None) -> Scorer[T]
```
...
```python
avg(scorer: Scorer[T], other: Scorer[T], *, name: str | None = None) -> Scorer[T]
```
...
```python
clip(scorer: Scorer[T], min_val: float, max_val: float, *, name: str | None = None) -> Scorer[T]
```
...
```python
invert(scorer: Scorer[T], *, known_max: float = 1.0, name: str | None = None) -> Scorer[T]
```
...
```python
normalize(scorer: Scorer[T], known_max: float, known_min: float = 0.0, *, name: str | None = None) -> Scorer[T]
```
...
```python
not_(scorer: Scorer[T], *, name: str | None = None) -> Scorer[T]
```
...
```python
or_(scorer: Scorer[T], other: Scorer[T], *, name: str | None = None) -> Scorer[T]
```
...
```python
remap_range(scorer: Scorer[T], *, known_min: float, known_max: float, new_min: float, new_max: float, name: str | None = None) -> Scorer[T]
```
...
```python
scale(scorer: Scorer[T], factor: float, *, name: str | None = None) -> Scorer[T]
```
...
```python
subtract(scorer: Scorer[T], other: Scorer[T], *, name: str | None = None) -> Scorer[T]
```
...
```python
threshold(scorer: Scorer[T], *, gt: float | None = None, gte: float | None = None, lt: float | None = None, lte: float | None = None, eq: float | None = None, ne: float | None = None, pass_value: float = 1.0, fail_value: float = 0.0, name: str | None = None) -> Scorer[T]
```
...
```python
weighted_avg(*scorers: tuple[Scorer[T], float], name: str | None = None) -> Scorer[T]
```
...
```python
detect_refusal_with_zero_shot(*, name: str = 'refusal_zero_shot') -> Scorer[t.Any]
```
...
```python
zero_shot_classification(labels: list[str], score_label: str, *, model_name: str = 'facebook/bart-large-mnli', name: str | None = None) -> Scorer[t.Any]
```
...
```python
character_consistency(reference: str, *, max_ratio_diff: float = 2.0, name: str = 'char_consistency') -> Scorer[t.Any]
```
...
```python
contains(pattern: str | Pattern[str], *, case_sensitive: bool = False, exact: bool = False, regex: bool = False, name: str = 'contains') -> Scorer[t.Any]
```
...
```python
detect_ansi_escapes(*, extra_patterns: list[str] | None = None, name: str = 'ansi_escapes') -> Scorer[t.Any]
```
...
```python
detect_bias(*, extra_patterns: list[str] | None = None, name: str = 'bias') -> Scorer[t.Any]
```
...
```python
detect_refusal(*, extra_patterns: list[str] | None = None, name: str = 'refusal') -> Scorer[t.Any]
```
...
```python
detect_sensitive_keywords(*, extra_patterns: list[str] | None = None, name: str = 'sensitive_keywords') -> Scorer[t.Any]
```
...
```python
detect_unsafe_shell_content(*, extra_patterns: list[str] | None = None, name: str = 'unsafe_shell_content') -> Scorer[t.Any]
```
...
```python
detect_harm_with_openai(*, api_key: str | None = None, model: str = 'text-moderation-stable', client: AsyncOpenAI | None = None, name: str = 'openai_harm') -> Scorer[t.Any]
```
...
```python
length_in_range(min_length: int = 0, max_length: float = float('inf'), *, name: str = 'length_in_range') -> Scorer[t.Any]
```
...
```python
length_ratio(reference: str, *, min_ratio: float = 0.1, max_ratio: float = 5.0, name: str = 'length_ratio') -> Scorer[t.Any]
```
...
```python
length_target(target_length: int, *, name: str = 'length_target') -> Scorer[t.Any]
```
...
```python
type_token_ratio(target_ratio: float | None = None, *, name: str = 'type_token_ratio') -> Scorer[t.Any]
```
...
```python
detect_pii(types: Sequence[Literal['email', 'phone', 'ip_address', 'ssn']] = ('email', 'phone', 'ip_address'), *, extra_patterns: list[str] | None = None, name: str = 'pii') -> Scorer[t.Any]
```
...
```python
detect_pii_with_presidio(*, entities: list[str] | None = None, threshold: float = 0.5, invert: bool = False, name: str = 'pii_presidio') -> Scorer[t.Any]
```
...
```python
readability(target_grade: float = 8.0, *, name: str = 'readability') -> Scorer[t.Any]
```
...
```python
wrap_chat(inner_scorer: Scorer[Any], *, filter: ChatFilterMode | ChatFilterFunction = 'last', name: str | None = None) -> Scorer[Chat]
```
...
```python
sentiment(target: Sentiment = 'neutral', name: str = 'score_sentiment') -> Scorer[t.Any]
```
...
```python
sentiment_with_perspective(*, api_key: str | None = None, attribute: PerspectiveAttribute = 'TOXICITY', name: str | None = None) -> Scorer[t.Any]
```
...
```python
bleu(reference: str, *, weights: tuple[float, ...] = (0.25, 0.25, 0.25, 0.25), name: str = 'bleu') -> Scorer[t.Any]
```
...
```python
distance(reference: str, *, method: Literal['levenshtein', 'hamming', 'jaro', 'jaro_winkler', 'damerau_levenshtein'] = 'levenshtein', normalize: bool = True, name: str = 'distance') -> Scorer[t.Any]
```
...
```python
similarity(reference: str, *, method: Literal['ratio', 'quick_ratio', 'real_quick_ratio'] = 'ratio', case_sensitive: bool = False, name: str = 'similarity') -> Scorer[t.Any]
```
...
```python
similarity_with_litellm(reference: str, model: str, *, api_key: str | None = None, api_base: str | None = None, name: str = 'similarity') -> Scorer[t.Any]
```
...
```python
similarity_with_rapidfuzz(reference: str, *, method: Literal['ratio', 'partial_ratio', 'token_sort_ratio', 'token_set_ratio', 'WRatio', 'QRatio'] = 'ratio', normalize: bool = True, preprocessor: bool = True, score_cutoff: float | None = None, name: str = 'similarity') -> Scorer[t.Any]
```
...
```python
similarity_with_sentence_transformers(reference: str, *, model_name: str = 'all-MiniLM-L6-v2', name: str = 'similarity') -> Scorer[t.Any]
```
...
```python
similarity_with_tf_idf(reference: str, *, name: str = 'similarity') -> Scorer[t.Any]
```
