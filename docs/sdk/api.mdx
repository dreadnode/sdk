...
* **`dataset`**
  ...
  –The dataset update request object.

**Returns:**

* **`DatasetMetadata`** ( `DatasetMetadata`
  ) –The updated DatasetMetadata object.
...
```python
upload_complete(request: DatasetUploadComplete) -> None
```
...
* **`DatasetUploadResponse`** ( `DatasetUploadResponse`
