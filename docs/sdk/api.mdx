...
```python
validate_value(value: Any) -> t.Any
```

<Accordion title="Source code in dreadnode/api/models.py" icon="code">
```python
...
```python
outputs: list[ObjectRef] | list[V0Object] = Field(
    repr=False
)
```
