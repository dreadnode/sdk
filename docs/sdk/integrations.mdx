...
```python
DreadnodeCallback(project: str | None = None, run_name: str | None = None, tags: list[str] | None = None)
```
...
```python
on_epoch_end(args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs: Any) -> None
```
...
```python
on_log(args: TrainingArguments, state: TrainerState, control: TrainerControl, logs: dict[str, Any] | None = None, **kwargs: Any) -> None
```
...
```python
on_step_begin(args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs: Any) -> None
```
...
```python
on_step_end(args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs: Any) -> None
```
...
```python
on_train_begin(args: TrainingArguments, state: TrainerState, control: TrainerControl, model: Any | None = None, **kwargs: Any) -> None
```
...
```python
on_train_end(args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs: Any) -> None
```
